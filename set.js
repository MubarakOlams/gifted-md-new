...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~zAIDCZaR#nnSWgDPwazvXGC7HGhgG-IKu87rQcTJiKHkiaEcrO6I", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2348112347304", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2348112375304", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "~¶∆№Mubarak¥ec𝐓𝐄𝐂𝐇", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "~¶∆№Mubarak¥ec𝐓𝐄𝐂𝐇", // Added // Input Yours custom...
